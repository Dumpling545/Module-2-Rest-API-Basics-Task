	...
	private void configureQueryByFilter(GiftCertificateSearchFilter giftCertificateSearchFilter, CriteriaBuilder criteriaBuilder,
		...
		if (giftCertificateSearchFilter.getTagNames() != null && !giftCertificateSearchFilter.getTagNames().isEmpty()) {
			...
			criteriaQuery.having(criteriaBuilder
					.equal(criteriaBuilder.count(tagJoin.get(Tag_.id)), giftCertificateSearchFilter.getTagNames().size()));
		...
		if (giftCertificateSearchFilter.getDescriptionPart() != null && !giftCertificateSearchFilter.getDescriptionPart().isBlank()) {
