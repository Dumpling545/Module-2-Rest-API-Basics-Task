...
public class GiftCertificateController {
	...
	@GetMapping(value = "/{id}")
	public GiftCertificateOutputDTO getCertificate(
	...
	{
		FilterDTO filterDTO =
				new FilterDTO(namePart, descriptionPart, sortOption,
						tagName);
	...
	@PostMapping
	public GiftCertificateOutputDTO createCertificate(
			@RequestBody GiftCertificateDTO certDTO)
	{
		return certService.createCertificate(certDTO);
	}

	@PutMapping(value = "/{id}")
	public GiftCertificateOutputDTO updateCertificate(
			@PathVariable int id,
			@RequestBody
					GiftCertificateDTO certDTO)
	{
		certDTO.setId(id);
